...
void NFCMasterNet_ServerModule::LogGameServer()
{
    ...
    m_pLogModule->LogInfo(NULL_GUID, "Begin Log WorldServer Info", "");
    ...
    m_pLogModule->LogInfo(NULL_GUID, "End Log WorldServer Info", "");

    m_pLogModule->LogInfo(NULL_GUID, "Begin Log LoginServer Info", "");
    ...
    m_pLogModule->LogInfo(NULL_GUID, "End Log LoginServer Info", "");
